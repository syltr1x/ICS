...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        l2 = customtkinter.CTkLabel(self.work_frame, text="Works").grid(row=1, column=1, padx=20, pady=10)

        # create third frame
        self.car_frame = customtkinter.CTkFrame(self, corner_radius=0, fg_color="transparent")
        l3 = customtkinter.CTkLabel(self.car_frame, text="Autos").grid(row=1, column=1, padx=20, pady=10)
